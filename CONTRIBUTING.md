# Contributing to FlexKey

Thank you for your interest in contributing to FlexKey! We welcome hardware enthusiasts, electronics engineers, and hobbyists to help improve our PCB designs, schematics, and documentation. 
...
* **EDA Tool:** Kicad
* **Mechanical CAD:** Fusion360 if you are modifying the 3D models or enclosure.
...
* **Reference Designator:** (e.g., "Resistor C2 footprint is too small").
